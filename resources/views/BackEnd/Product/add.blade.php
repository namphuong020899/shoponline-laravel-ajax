...
@section('content') 
	...
	<div class="wrapper wrapper-content animated fadeInRight">
        <form action="{{ route('product.store') }}" method="post" enctype="multipart/form-data" role="form" id="form">
    	@csrf
		<div class="row">
		    <div class="col-lg-6">
		        <div class="ibox" id="ibox2">
		            ...
		            <div class="ibox-content">
	                    ...
	                    <div class="form-group row {{$errors->has('product_name') ? 'has-error' : ''}}"><label class="col-sm-2 col-form-label">Name <sup class="text-danger">*</sup></label>
	                        <div class="col-sm-10">
	                        	<input type="text" class="form-control" name="product_name" id="slug_name" onkeyup="ChangeToSlug();" value="{{old('product_name')}}"> 
	                    ...
	                    <div class="form-group row {{$errors->has('product_slug') ? 'has-error' : ''}}"><label class="col-sm-2 col-form-label">Slug <sup class="text-danger">*</sup></label>
	                        <div class="col-sm-10">
	                        	<input type="text" class="form-control" name="product_slug" id="slug" value="{{old('product_slug')}}"> 
	                    ...
	                    <div class="form-group {{$errors->has('product_desc') ? 'has-error' : ''}}">
	                    	...
	                    	<textarea   rows="5" name="product_desc" required=""></textarea>
	                    </div>
	                    <div class="form-group row {{$errors->has('product_price') ? 'has-error' : ''}}"><label class="col-sm-2 col-form-label">Price <sup class="text-danger">*</sup></label>
	                        <div class="col-sm-10 input-group">
	                        	<input type="text" class="form-control" data-mask="99,999,999" name="product_price" id="change_price" onkeyup="ChangeToPrice();" value="{{old('product_price')}}">
	                        	<input type="hidden" class="form-control" name="product_price_hidden" value="{{old('product_price_hidden')}}" id="pirce_hidden">
	                    ...
	                    <div class="form-group row {{$errors->has('promotion_price') || Session::get('message_err') ? 'has-error' : ''}}"><label class="col-sm-2 col-form-label">Promotion</label>
	                        <div class="col-sm-10 input-group">
	                        	<input type="mumber" class="form-control" data-mask="99,999,999" name="promotion_price" id="promotion_price" onkeyup="ChangeToPrice();" value="{{old('promotion_price')}}"> 
	                        	<input type="hidden" class="form-control" name="promotion_price_hidden" id="promotion_price_hidden" value="{{old('promotion_price_hidden')}}">
	                        	<span class="input-group-addon">
                                    <span>VNĐ</span>
                                </span>
	                    ...
	                    <div class="form-group row {{$errors->has('product_quantity') ? 'has-error' : ''}}"><label class="col-sm-2 col-form-label">Quantity <sup class="text-danger">*</sup></label>
	                        <div class="col-sm-10">
	                        	<input type="number" class="form-control" name="product_quantity" min="1" value="{{old('product_quantity')}}"  oninput="this.value = Math.abs(this.value)"> 
	                    ...
	                    <div class="form-group row {{$errors->has('product_view') ? 'has-error' : ''}}"><label class="col-sm-2 col-form-label">View</label>
	                        <div class="col-sm-10">
	                        	<input type="number" class="form-control" name="product_view" min="0" value="0"  oninput="this.value = Math.abs(this.value)"> 
		            ...
		            <div class="ibox-content">
	                    ...
	                    <div id="data_3" class="form-group row {{$errors->has('product_date_sale') ? 'has-error' : ''}}"><label class="col-sm-2 col-form-label">Date Sale</label>
	                        <div class="col-sm-10 input-group date">
                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" class="form-control" name="product_date_sale" value="{{now()->format('Y/m/d')}}">
	                    ...
	                    <div class="form-group row {{$errors->has('product_hour_sale') ? 'has-error' : ''}}"><label class="col-sm-2 col-form-label">Hour Sale</label>
	                        <div class="col-sm-10 input-group clockpicker" data-autoclose="true">
                                <input type="text" class="form-control" value="00:00" name="product_hour_sale">
                                <span class="input-group-addon">
	                    ...
	                    <div class="form-group {{$errors->has('product_content') ? 'has-error' : ''}}">
	                    	...
	                    	<textarea  rows="5" name="product_content" required=""></textarea>
	                    </div>
	                    <div class="form-group row {{$errors->has('category_id') ? 'has-error' : ''}}"><label class="col-sm-2 col-form-label">Category</label>
	                        <div class="col-sm-10">
                                <select class="chosen-select" name="category_id">
                                	...
                                	<option style="text-transform: capitalize;" value="{{$category->category_id}}">{{$category->category_name}}</option>
                                	@endforeach
                                </select>
	                        </div>
	                    </div>
	                    <div class="form-group row {{$errors->has('brand_id') ? 'has-error' : ''}}"><label class="col-sm-2 col-form-label">Brand</label>
	                        <div class="col-sm-10">
	                        	<select class="chosen-select" name="brand_id">
                                    ...
                                    <option style="text-transform: capitalize;" value="{{$brand->brand_id}}">{{$brand->brand_name}}</option>
                                    @endforeach
                                </select> 
	                        </div>
	                    </div>
	                    <div class="form-group row"><label class="col-sm-2 col-form-label">Status <sup class="text-danger">*</sup></label>
	                        <div class="col-sm-10">
	                        	<select class="chosen-select" name="product_status">
                                    ...
                                    <option value="1">Product New</option>
                                    <option value="2">Product Hidden</option>
                                </select> 
		...
		<div class="row">
		    <div class="col-lg-12"> 
		    	<div id="displayImg" class="displayImg">
		    		{{-- <img src="{{ asset('uploads/product/1629271565_5.jpg') }}"> --}}
		    	</div>
		    </div>
		</div>
	</div>
