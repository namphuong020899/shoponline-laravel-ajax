        ...
        <div class="modal inmodal" id="Modal_edit" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content animated bounceInRight">
                    ...
                    <form id="sample_profile_form" enctype="multipart/form-data" method="POST">
                        <div class="modal-body">
                ...
                $.ajax({
                    ...
                    success:function(response){
                        if (response.status == 404) {
                            ...
                            $('#user_name').val(response.profile_login.user_name);
                            $('#email').val(response.profile_login.email);
                            $('#level').val(response.profile_login.level);
                            $('#account_user_id').val(account_id);
                            $('#image_show_account').html('');
                            $('#image_show_account').append('<img src="uploads/profile/'+response.profile_login.image_user+'" alt="" class="modal-icon img-thumbnail" width="80px" height="80px">');
