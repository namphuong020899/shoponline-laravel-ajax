                ...
                <div class="container">
                    <div class="breadcrumb-content">
                        <ul>
                            ...
                            <li class="active" style="text-transform: capitalize;">Search : "{{$request_search}}"</li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <div class="shop-top-bar mt-30">
                                <div class="shop-bar-inner">
                                    ...
                                    <div class="toolbar-amount">
                                        <!-- <span>Showing 1 to {{$product_search->count()}} of {{$product_search->count()}}</span> -->
                                    </div>
                                </div>
                                ...
                                <div class="product-select-box">
                                    <div class="product-short">
                                        <p>Sort By:</p>
                                        <input type="hidden" name="hidden_cate" id="hidden_cate" value="{{$request_search}}">
                                    ...
                                    <div id="grid-view" class="tab-pane fade active show" role="tabpanel">
                                        <div class="product-area shop-product-area">
                                            <div class="row" id="productData">
                                            	@foreach($product_search as $pro_cate)
...
<script type="text/javascript">
    $(document).ready(function(){
        $(document).on('change','#sort',function(e){
            e.preventDefault();
            var change = $(this).val();
            var search = $('#hidden_cate').val();
            
            $.ajax({
                type: 'get',
                url: '{{ route('search.index') }}',
                data: {change:change,search:search},
                dataType: 'html',
